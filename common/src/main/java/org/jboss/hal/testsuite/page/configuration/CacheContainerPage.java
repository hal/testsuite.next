...
public class CacheContainerPage extends BasePage {
    ...
    @FindBy(id = Ids.CACHE_CONTAINER_ENTRY) private WebElement configurationItem;
    @FindBy(id = Ids.CACHE_CONTAINER_FORM) private FormFragment configurationForm;
    @FindBy(id = Ids.LOCAL_CACHE + "-entry") private WebElement localCacheItem;
    @FindBy(id = Ids.LOCAL_CACHE + "-table_wrapper") private TableFragment localCacheTable;
