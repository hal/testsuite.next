...
public class MimeMappingTest {
    ...
    @Test
    public void editMimeMapping() throws Exception {
        crudOperations.update(UndertowFixtures.servletContainerAddress(SERVLET_CONTAINER_EDIT).and("mime-mapping", "aaa"),
            page.getMimeMappingForm(),
            formFragment ->
                formFragment.properties("mime-mapping").add("aaa", "bbb"),
            resourceVerifier -> {
