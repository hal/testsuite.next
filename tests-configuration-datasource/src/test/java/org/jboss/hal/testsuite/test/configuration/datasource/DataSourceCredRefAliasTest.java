...
public class DataSourceCredRefAliasTest extends DataSourceCredRefBase {

    /**
     * Update the alias and clear-text value of the credential reference. The number of aliases in the credential store must increase by one.
     */
    @Test
