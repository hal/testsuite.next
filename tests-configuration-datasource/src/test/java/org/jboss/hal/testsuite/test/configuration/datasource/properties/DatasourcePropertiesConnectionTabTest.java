...
public class DatasourcePropertiesConnectionTabTest extends AbstractDatasourcePropertiesTest {
    ...
    public static void cleanUp()
        ...
        try {
            ...
            operations.removeIfExists(dataSourceAddress(MYSQL_DATASOURCE_NAME));
            operations.removeIfExists(xaDataSourceAddress(MSSQL_XA_DATASOURCE_NAME));
            operations.removeIfExists(dataSourceAddress(MSSQL_DATASOURCE_NAME));
            operations.removeIfExists(xaDataSourceAddress(CUSTOM_XA_DATASOURCE_NAME));
            operations.removeIfExists(dataSourceAddress(CUSTOM_DATASOURCE_NAME));
            administration.reloadIfRequired();
        } finally {
            client.close();
        }
