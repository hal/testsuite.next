...
public class AddModule implements OnlineCommand {
    ...
    private AddModule(AddModule.Builder builder) {
    ...
    public static final class Builder {
         ...
         * </a>
         */
        public AddModule.Builder moduleRootDir(File moduleRootDir) {
            if (moduleRootDir == null) {
         ...
         */
        public AddModule.Builder property(String name, String value) {
            if (name == null) {
