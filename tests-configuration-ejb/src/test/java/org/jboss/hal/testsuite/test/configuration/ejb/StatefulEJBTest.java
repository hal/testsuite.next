...
import org.jboss.hal.testsuite.test.configuration.ejb.ejb.StatefulEJBExecutionTime;
import org.jboss.hal.testsuite.test.configuration.ejb.ejb.StatefulEJBInvocations;
import org.jboss.hal.testsuite.test.configuration.ejb.ejb.StatefulEJBPeakInvocations;
import org.jboss.hal.testsuite.test.configuration.ejb.ejb.StatefulEJBWithRoles;
import org.jboss.hal.testsuite.test.configuration.ejb.ejb.StatefulGreeterEJB;
import org.jboss.hal.testsuite.test.configuration.ejb.ejb.StatefulServlet;
...
import static org.jboss.hal.testsuite.fixtures.EJBFixtures.statefulEJBAddress;
...
public class StatefulEJBTest extends AbstractEJBTest {
    ...
    public void verifyComponentClassName() throws Exception {
        ...
        new ResourceVerifier(statefulEJBAddress(STATEFUL_EJB_DEPLOYMENT_NAME, StatefulGreeterEJB.class),
            client)
            .verifyExists()
    ...
    public void verifyDeclaredRoles() throws Exception {
        ...
        new ResourceVerifier(
            statefulEJBAddress(STATEFUL_EJB_DEPLOYMENT_WITH_ROLES_NAME, StatefulEJBWithRoles.class),
            client)
            .verifyExists()
    ...
    public void verifyInvocations() throws Exception {
        ...
        new ResourceVerifier(
            statefulEJBAddress(STATEFUL_EJB_DEPLOYMENT_INVOCATIONS_NAME, StatefulEJBInvocations.class),
            client)
            .verifyExists()
    ...
    public void verifyPeakConcurrentInvocations() throws Exception {
        ...
        new ResourceVerifier(statefulEJBAddress(STATEFUL_EJB_DEPLOYMENT_PEAK_CONCURRENT_INVOCATIONS_NAME,
