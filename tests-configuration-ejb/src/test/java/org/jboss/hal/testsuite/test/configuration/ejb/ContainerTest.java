...
import static org.jboss.hal.testsuite.fixtures.EJBFixtures.DEFAULT_DISTINCT_NAME;
import static org.jboss.hal.testsuite.fixtures.EJBFixtures.DEFAULT_SINGLETON_BEAN_ACCESS_TIMEOUT;
...
public class ContainerTest {
    ...
    public static void tearDown() throws Exception {
        operations.undefineAttribute(SUBSYSTEM_ADDRESS, DEFAULT_DISTINCT_NAME);
        operations.writeAttribute(SUBSYSTEM_ADDRESS, DEFAULT_SINGLETON_BEAN_ACCESS_TIMEOUT, 5000);
    }
