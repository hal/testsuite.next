...
import static org.jboss.hal.testsuite.fixtures.EJBFixtures.CLUSTER;
import static org.jboss.hal.testsuite.fixtures.EJBFixtures.SERVICE_REMOTE_ADDRESS;
...
import static org.jboss.hal.testsuite.fixtures.InfinispanFixtures.SUBSYSTEM_ADDRESS;
...
public class ServiceRemoteTest {
    ...
    public static void tearDown() throws Exception {
        operations.writeAttribute(SERVICE_REMOTE_ADDRESS, THREAD_POOL_NAME, DEFAULT);
        operations.undefineAttribute(SERVICE_REMOTE_ADDRESS, CLUSTER);
