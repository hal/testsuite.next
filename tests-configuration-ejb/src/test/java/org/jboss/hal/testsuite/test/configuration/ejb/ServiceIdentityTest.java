...
import static org.jboss.hal.testsuite.fixtures.EJBFixtures.OUTFLOW_SECURITY_DOMAINS;
import static org.jboss.hal.testsuite.fixtures.EJBFixtures.SERVICE_IDENTITY_ADDRESS;
...
public class ServiceIdentityTest {
    ...
    public void add() throws Exception {
        ...
        new ResourceVerifier(SERVICE_IDENTITY_ADDRESS, client)
                .verifyExists();
    }
