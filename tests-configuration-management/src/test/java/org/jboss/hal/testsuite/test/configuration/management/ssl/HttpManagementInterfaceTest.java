...
public class HttpManagementInterfaceTest {
    ...
    private final SnapshotBackup snapshot = new SnapshotBackup();
    ...
    public static void cleanUp() throws IOException {
        FILE_NAMES_TO_BE_DELETED.forEach(fileName -> FileUtils.deleteQuietly(new File(keyStoresDirectory, fileName)));
        client.close();
    }

    @Before
    public void backup() throws CommandFailedException {
        client.apply(snapshot.backup());
    }

    @After
    public void restoreBackup() throws CommandFailedException {
...
//                clientKeyStorePathValue, clientKeyStorePasswordValue);
    ...
    private void reloadOneWaySecuredManagementWithClientUpdate(String serverKeyStoreNameValue,
            String serverKeyAliasValue)
            throws IOException, InterruptedException, TimeoutException {
        SslOptionsCreator clientSslOptionsCreator = (creaperTrustStorePath, creaperTrustStorePassword) -> new SslOptions.Builder()
    ...
    @SuppressWarnings("unused")
    private void reloadMutualSecuredManagementWithClientUpdate(String serverKeyStoreNameValue,
            String serverKeyAliasValue,
    ...
    private void reloadWithClientUpdate(String serverKeyStoreNameValue, String serverKeyAliasValue,
            SslOptionsCreator sslOptionsCreator)
            throws IOException, InterruptedException, TimeoutException {
        String
    ...
    @FunctionalInterface
    private interface SslOptionsCreator {
