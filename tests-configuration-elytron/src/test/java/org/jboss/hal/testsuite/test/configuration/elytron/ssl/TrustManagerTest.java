...
public class TrustManagerTest {
    ...
    private static void createKeyStore(String name) throws IOException {
        ...
        credentialReference.get(ModelDescriptionConstants.CLEAR_TEXT).set(Random.name());
        operations.add(keyStoreAddress(name),
                Values.of(ModelDescriptionConstants.TYPE, "JKS").and(ModelDescriptionConstants.CREDENTIAL_REFERENCE, credentialReference)
