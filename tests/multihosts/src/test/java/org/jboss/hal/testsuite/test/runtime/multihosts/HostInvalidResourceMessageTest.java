...
public class HostInvalidResourceMessageTest {

    @Inject private Console console;

    @Test
    public void checkHostInvalidMessage() throws Exception {
        FinderFragment finder = console.finder(NameTokens.RUNTIME, new FinderPath().append(DOMAIN_BROWSE_BY, HOSTS));
        finder.column(HOST).selectItem(HOST + "-" + ConfigUtils.getDefaultHost());
