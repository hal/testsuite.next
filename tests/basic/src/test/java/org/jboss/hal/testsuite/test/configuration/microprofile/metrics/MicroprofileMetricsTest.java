...
public class MicroprofileMetricsTest {
    ...
    public void toggleExposeAllSubsystems() throws Exception {
        boolean exposeAllSubsystems =
            operations.readAttribute(MicroprofileMetricsFixtures.MICROPROFILE_METRICS_ADDRESS,
                MicroprofileMetricsFixtures.EXPOSED_SUBSYSTEMS)
                .value()
        ...
        page.navigate();
        crudOperations.update(MicroprofileMetricsFixtures.MICROPROFILE_METRICS_ADDRESS, page.getMicroprofileMetricsForm(),
            formFragment -> {
                if (exposeAllSubsystems) {
                    formFragment.flip(MicroprofileMetricsFixtures.EXPOSE_ALL_SUBSYSTEMS, false);
                    exposedSubsystems.set(Optional.of(Arrays.asList(Random.name(), Random.name())));
                    formFragment.list(MicroprofileMetricsFixtures.EXPOSED_SUBSYSTEMS).add(exposedSubsystems.get().get());
                } else {
                    formFragment.flip(MicroprofileMetricsFixtures.EXPOSE_ALL_SUBSYSTEMS, true);
                }
            }, resourceVerifier -> {
                ...
                resourceVerifier.verifyAttribute(MicroprofileMetricsFixtures.EXPOSED_SUBSYSTEMS, value);
            });
    }
    ...
    public void editExposedSubsystems() throws Exception {
        ...
        crudOperations.update(MicroprofileMetricsFixtures.MICROPROFILE_METRICS_ADDRESS, page.getMicroprofileMetricsForm(),
            formFragment -> {
                ...
                formFragment.list(MicroprofileMetricsFixtures.EXPOSED_SUBSYSTEMS).add(Arrays.asList(exposedSubsystems));
            }, resourceVerifier -> resourceVerifier.verifyAttribute(MicroprofileMetricsFixtures.EXPOSED_SUBSYSTEMS,
    ...
    public void toggleSecurityEnabled() throws Exception {
        boolean securityEnabled =
            operations.readAttribute(MicroprofileMetricsFixtures.MICROPROFILE_METRICS_ADDRESS,
                MicroprofileMetricsFixtures.SECURITY_ENABLED)
                .booleanValue(false);
        page.navigate();
        crudOperations.update(MicroprofileMetricsFixtures.MICROPROFILE_METRICS_ADDRESS,
            page.getMicroprofileMetricsForm(), MicroprofileMetricsFixtures.SECURITY_ENABLED, !securityEnabled);
    }
}
