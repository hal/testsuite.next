...
public class PreHandlerChainHandlerTest {
    ...
    public static void setUp() throws IOException {
        ...
        createHandler(PRE_HANDLER_CHAIN_HANDLER_DELETE);
        createHandler(PRE_HANDLER_CHAIN_HANDLER_EDIT);
    }
    ...
    public void initPage() {
        ...
        page.getEndpointConfigurationHandlerChainTable().action(PRE_HANDLER_CHAIN_EDIT.getHandlerChainName(), "Handler");
    }
    ...
    public void create() throws Exception {
        crudOperations.create(
            ...
            page.getEndpointConfigurationHandlerTable(), formFragment -> {
                ...
                resourceVerifier.verifyAttribute(WebServicesFixtures.CLASS, PRE_HANDLER_CHAIN_HANDLER_CREATE.getClassName());
            });
    }
