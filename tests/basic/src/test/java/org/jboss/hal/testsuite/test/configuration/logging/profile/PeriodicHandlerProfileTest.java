...
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.PERIODIC_HANDLER_DELETE;
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.PERIODIC_HANDLER_READ;
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.PERIODIC_HANDLER_UPDATE;
...
public class PeriodicHandlerProfileTest extends PeriodicHandlerAbstractTest {
    ...
    public static void setUp() throws IOException {
        profileName = Ids.build(PeriodicHandlerProfileTest.class.getSimpleName(), Random.name());
    ...
    private static Address handlerAddress(String name) {
        return profileAddress.and(PERIODIC_ROTATING_FILE_HANDLER, name);
    }
