...
public class PatternFormatterProfileTest extends PatternFormatterAbstractTest {
    ...
    public static void setUp() throws IOException {
        profileName = Ids.build(PatternFormatterProfileTest.class.getSimpleName(), Random.name());
