...
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.FILE_HANDLER_DELETE;
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.FILE_HANDLER_READ;
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.FILE_HANDLER_UPDATE;
...
public class FileHandlerProfileTest extends FileHandlerAbstractTest {
    ...
    public static void setUp() throws IOException {
        profileName = Ids.build(FileHandlerProfileTest.class.getSimpleName(), Random.name());
    ...
    private static Address handlerAddress(String name) {
        return profileAddress.and(FILE_HANDLER, name);
    }
