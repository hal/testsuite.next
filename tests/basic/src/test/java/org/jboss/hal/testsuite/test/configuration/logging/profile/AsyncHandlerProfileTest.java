...
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.ASYNC_HANDLER_DELETE;
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.ASYNC_HANDLER_UPDATE;
...
public class AsyncHandlerProfileTest extends AsyncHandlerAbstractTest {
    ...
    public static void setUp() throws IOException {
        profileName = Ids.build(AsyncHandlerProfileTest.class.getSimpleName(), Random.name());
    ...
    private static Address handlerAddress(String name) {
        return profileAddress.and(ASYNC_HANDLER, name);
    }
