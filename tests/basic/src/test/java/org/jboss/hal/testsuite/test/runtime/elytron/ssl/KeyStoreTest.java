...
public class KeyStoreTest {
    ...
    public static void setUp() throws IOException {
        ...
        // add a keystore
        operations.add(keyStoreAddress(KEY_STORE_NAME), Values.of(TYPE, JKS)
        ...
        operations.invoke(GENERATE_KEY_PAIR, keyStoreAddress(KEY_STORE_NAME2), Values.of(ALIAS, ALIAS_TRY_TO_RENAME)
                ...
                .and(SIGNATURE_ALGORITHM, SHA_256_WITH_RSA)
                .and(ALGORITHM, RSA));
        operations.invoke(GENERATE_KEY_PAIR, keyStoreAddress(KEY_STORE_NAME2), Values.of(ALIAS, ALIAS_TO_EXPORT)
                .and(DISTINGUISHED_NAME, "cn=to-export")
                .and(SIGNATURE_ALGORITHM, SHA_256_WITH_RSA)
                .and(ALGORITHM, RSA));
        operations.invoke(GENERATE_KEY_PAIR, keyStoreAddress(KEY_STORE_NAME2), Values.of(ALIAS, ALIAS_TO_REMOVE)
                .and(DISTINGUISHED_NAME, "cn=to-remove")
                .and(SIGNATURE_ALGORITHM, SHA_256_WITH_RSA)
                .and(ALGORITHM, RSA));
    ...
    public void generateKeyPair() {
        ...
        dialog.getForm().text(ALIAS, ALIAS_GEN_KEY);
        dialog.getForm().text(DISTINGUISHED_NAME, "cn=" + ALIAS_GEN_KEY);
    ...
    public void tryGenerateKeyPair() {
        ...
        AddResourceDialogFragment dialog = console.addResourceDialog();
        dialog.getPrimaryButton().click();
        dialog.getForm().expectError(ALIAS);
    ...
    public void generateKeyPairFull() {
        ...
        page.getKeyStoreTable().button("Generate Key Pair").click();
        AddResourceDialogFragment dialog = console.addResourceDialog();
        dialog.getForm().text(ALGORITHM, RSA);
        dialog.getForm().text(ALIAS, ALIAS_GEN_KEY_FULL);
        dialog.getForm().text(DISTINGUISHED_NAME, "cn=" + ALIAS_GEN_KEY_FULL);
        ...
        dialog.getForm().number(VALIDITY, 250);
        dialog.getPrimaryButton().click();
        console.verifySuccess();
    }
    ...
    public void obtainCertificateStaging() {
        ...
        dialog.getForm().text(ALIAS, ALIAS_OBTAIN_STAGING);
        dialog.getForm().text(CERTIFICATE_AUTHORITY_ACCOUNT, CERTIFICATE_AUTHORITY_ACCOUNT_UPDATE);
    ...
    public void obtainCertificate() {
        ...
        AddResourceDialogFragment dialog = console.addResourceDialog();
        dialog.getForm().flip(AGREE_TO_TERMS_OF_SERVICE, true);
        dialog.getForm().text(ALIAS, ALIAS_OBTAIN);
        dialog.getForm().text(CERTIFICATE_AUTHORITY_ACCOUNT, CERTIFICATE_AUTHORITY_ACCOUNT_UPDATE);
    ...
    public void importCertificate() {
        ...
        AddResourceDialogFragment dialog = console.addResourceDialog();
        dialog.getForm().text(ALIAS, ALIAS_IMPORTED);
        dialog.getForm().text(PATH, EXPORTED_CERT_FILENAME);
        dialog.getForm().flip(TRUST_CACERTS, true);
        dialog.getForm().flip(VALIDATE, false);
        dialog.getPrimaryButton().click();
        console.verifySuccess();
    }
    ...
    public void generateAliasCSR() {
        ...
        AddResourceDialogFragment dialog = console.addResourceDialog();
        dialog.getForm().text(PATH, EXPORTED_CSR_FILENAME);
        dialog.getPrimaryButton().click();
        console.verifySuccess();
    }
