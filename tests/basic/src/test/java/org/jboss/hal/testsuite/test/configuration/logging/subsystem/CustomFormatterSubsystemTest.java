...
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.CUSTOM_FORMATTER_CREATE;
...
public class CustomFormatterSubsystemTest extends CustomFormatterAbstractTest {
    ...
    public static void tearDown() throws IOException, OperationException, InterruptedException, TimeoutException {
        try {
            ops.removeIfExists(formatterAddress(CUSTOM_FORMATTER_CREATE));
            ops.removeIfExists(formatterAddress(CUSTOM_FORMATTER_UPDATE));
            ops.removeIfExists(formatterAddress(CUSTOM_FORMATTER_RESET));
            ops.removeIfExists(formatterAddress(CUSTOM_FORMATTER_DELETE));
