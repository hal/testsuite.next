...
public class PeriodicSizeHandlerTest extends PeriodicSizeHandlerAbstractTest {
    ...
    public static void createResources() throws IOException {
        ...
        ops.add(LoggingFixtures.LoggingProfile.periodicSizeHandlerAddress(LOGGING_PROFILE, PERIODIC_SIZE_HANDLER_UPDATE),
            Values.of(FILE, file.clone()).and(SUFFIX, SUFFIX_VALUE)).assertSuccess();
        ops.add(LoggingFixtures.LoggingProfile.periodicSizeHandlerAddress(LOGGING_PROFILE, PERIODIC_SIZE_HANDLER_DELETE),
            Values.of(FILE, file.clone()).and(SUFFIX, SUFFIX_VALUE)).assertSuccess();
    }
