 ...
 */
package org.jboss.hal.testsuite.test.configuration.logging.logging.profiles.formatter.json.formatter;
...
public class JsonFormatterTest extends JsonFormatterAbstractTest {
    ...
    public static void createResources() throws IOException {
        ...
        ops.add(LoggingFixtures.LoggingProfile.jsonFormatterAddress(LOGGING_PROFILE, JSON_FORMATTER_DELETE)).assertSuccess();
    }
