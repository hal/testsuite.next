...
import org.jboss.hal.testsuite.test.runtime.ejb.ejb.SingletonCounterEJB;
import org.jboss.hal.testsuite.test.runtime.ejb.ejb.SingletonEJBWithRoles;
import org.jboss.hal.testsuite.test.runtime.ejb.ejb.SingletonServlet;
...
public class SingletonEJBTest extends AbstractEJBTest {
    ...
    public void verifyComponentClassName() throws Exception {
        ...
        new ResourceVerifier(EJBFixtures.singletonEJBAddress(SINGLETON_EJB_DEPLOYMENT_NAME, SingletonCounterEJB.class),
            client)
            .verifyExists()
    ...
    public void verifyDeclaredRoles() throws Exception {
        ...
        new ResourceVerifier(
            EJBFixtures.singletonEJBAddress(SINGLETON_EJB_DEPLOYMENT_WITH_ROLES_NAME, SingletonEJBWithRoles.class),
            client)
            .verifyExists()
    ...
    public void verifyInvocations() throws Exception {
        ...
        new ResourceVerifier(
            EJBFixtures.singletonEJBAddress(SINGLETON_EJB_DEPLOYMENT_INVOCATIONS_NAME, SingletonCounterEJB.class), client)
            .verifyExists()
    ...
    public void verifyPeakConcurrentInvocations() throws Exception {
        ...
        new ResourceVerifier(EJBFixtures.singletonEJBAddress(SINGLETON_EJB_DEPLOYMENT_PEAK_CONCURRENT_INVOCATIONS_NAME,
