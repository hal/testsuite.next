...
public class ChannelTest {
    ...
    public static void tearDown() throws Exception {
        ...
        operations.removeIfExists(channelAddress(CHANNEL_UPDATE));
        operations.removeIfExists(channelAddress(CHANNEL_DELETE));
    }
    ...
    public void reset() throws Exception {
        ...
        form.reset();
        console.verifySuccess();
        new ResourceVerifier(channelAddress(CHANNEL_UPDATE), client).verifyReset();
    }
