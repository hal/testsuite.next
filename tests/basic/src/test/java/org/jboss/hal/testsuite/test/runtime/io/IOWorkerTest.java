...
public class IOWorkerTest {
    ...
    public void verifyCorePoolSize() throws IOException, TimeoutException, InterruptedException {
        ...
        IOWorkerPreviewFragment ioWorkerPreviewFragment = getIOWorkerFragment().preview(IOWorkerPreviewFragment.class);
        operations.writeAttribute(IOFixtures.workerAddress(org.jboss.hal.testsuite.test.runtime.io.IOFixtures.DEFAULT_IO_WORKER), "task-max-threads", taskMaxThreads);
        administration.reloadIfRequired();
    ...
    public void verifyIOThreadCount() throws IOException, TimeoutException, InterruptedException {
        ...
        IOWorkerPreviewFragment ioWorkerPreviewFragment = getIOWorkerFragment().preview(IOWorkerPreviewFragment.class);
        operations.writeAttribute(IOFixtures.workerAddress(org.jboss.hal.testsuite.test.runtime.io.IOFixtures.DEFAULT_IO_WORKER), "io-threads", ioThreads);
        administration.reloadIfRequired();
        ioWorkerPreviewFragment.refresh();
    ...
    private FinderFragment getIOWorkerFragment() throws IOException {
        ...
        if (ConfigUtils.isDomain()) {
            ...
            finderPath = runtimeSubsystemPath(serverEnvironmentUtils.getServerHostName(), "io");
        }
        finderPath.append("worker", org.jboss.hal.testsuite.test.runtime.io.IOFixtures.DEFAULT_IO_WORKER);
