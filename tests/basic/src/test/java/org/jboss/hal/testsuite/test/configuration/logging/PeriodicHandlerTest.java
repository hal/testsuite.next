...
public class PeriodicHandlerTest {
    ...
    public void create() throws Exception {
        crud.create(periodicHandlerAddress(PERIODIC_HANDLER_CREATE), table, form -> {
            ...
            FileInputFragment fileInput = createPageFragment(FileInputFragment.class,
                    form.getRoot().findElement(By.id("logging-handler-periodic-rotating-file-table-add-file-editing")));
    ...
    public void update() throws Exception {
        ...
        crud.update(periodicHandlerAddress(PERIODIC_HANDLER_UPDATE), form,
    ...
    public void reset() throws Exception {
        table.select(PERIODIC_HANDLER_UPDATE);
        crud.reset(periodicHandlerAddress(PERIODIC_HANDLER_UPDATE), form);
    }

    @Test
    public void delete() throws Exception {
        crud.delete(periodicHandlerAddress(PERIODIC_HANDLER_DELETE), table, PERIODIC_HANDLER_DELETE);
    }
}
