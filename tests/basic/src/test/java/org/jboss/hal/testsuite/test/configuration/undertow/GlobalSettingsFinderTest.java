...
public class GlobalSettingsFinderTest {
    ...
    public void view() {
        console.finder(NameTokens.CONFIGURATION, FinderFragment.configurationSubsystemPath(NameTokens.UNDERTOW))
            ...
            .selectItem(Ids.UNDERTOW_GLOBAL_SETTINGS)
            .view();
        console.verify(new PlaceRequest.Builder().nameToken(NameTokens.UNDERTOW).build());
    }
