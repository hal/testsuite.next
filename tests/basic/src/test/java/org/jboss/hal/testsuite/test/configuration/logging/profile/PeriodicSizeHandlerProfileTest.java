...
public class PeriodicSizeHandlerProfileTest extends PeriodicSizeHandlerAbstractTest {
    ...
    public static void setUp() throws IOException {
        profileName = Ids.build(PeriodicSizeHandlerProfileTest.class.getSimpleName(), Random.name());
