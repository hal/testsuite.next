...
@JMSDestinationDefinition(name = "java:/queue/MessageDrivenInvocationsQueue",
    interfaceName = "javax.jms.Queue")
@WebServlet(name = "MessageDriven", urlPatterns = "/MessageDriven")
public class MessageServletInvocations extends HttpServlet {
    ...
    @Resource(lookup = "java:/queue/MessageDrivenInvocationsQueue")
    private Queue queue;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < MSG_COUNT; i++) {
                String text = "This is message for MessageDrivenInvocations " + (i + 1);
