...
public class SocketHandlerSubsystemTest extends SocketHandlerAbstractTest {
    ...
    public static void tearDown() throws IOException, OperationException, InterruptedException, TimeoutException {
        try {
            ops.removeIfExists(handlerAddress(SOCKET_HANDLER_CREATE));
            ops.removeIfExists(handlerAddress(SOCKET_HANDLER_UPDATE));
            ops.removeIfExists(handlerAddress(SOCKET_HANDLER_DELETE));
