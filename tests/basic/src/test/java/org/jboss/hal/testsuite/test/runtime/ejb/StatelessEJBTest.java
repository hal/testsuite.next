...
import org.jboss.hal.testsuite.test.runtime.ejb.ejb.StatelessEJBWithRoles;
import org.jboss.hal.testsuite.test.runtime.ejb.ejb.StatelessGreeterEJB;
import org.jboss.hal.testsuite.test.runtime.ejb.ejb.StatelessServlet;
...
public class StatelessEJBTest extends AbstractEJBTest {
    ...
    public void verifyComponentClassName() throws Exception {
        ...
        new ResourceVerifier(EJBFixtures.statelessEJBAddress(STATELESS_EJB_DEPLOYMENT_NAME, StatelessGreeterEJB.class),
            client)
            .verifyExists()
    ...
    public void verifyDeclaredRoles() throws Exception {
        ...
        new ResourceVerifier(
            EJBFixtures.statelessEJBAddress(STATELESS_EJB_DEPLOYMENT_WITH_ROLES_NAME, StatelessEJBWithRoles.class),
            client)
            .verifyExists()
    ...
    public void verifyExecutionTime() throws Exception {
        ...
        new ResourceVerifier(
            EJBFixtures.statelessEJBAddress(STATELESS_EJB_DEPLOYMENT_EXECUTION_TIME_NAME, StatelessGreeterEJB.class),
            client)
            .verifyExists()
    ...
    public void verifyInvocations() throws Exception {
        ...
        new ResourceVerifier(
            EJBFixtures.statelessEJBAddress(STATELESS_EJB_DEPLOYMENT_INVOCATIONS_NAME, StatelessGreeterEJB.class), client)
            .verifyExists()
    ...
    public void verifyPeakConcurrentInvocations() throws Exception {
        ...
        new ResourceVerifier(EJBFixtures.statelessEJBAddress(STATELESS_EJB_DEPLOYMENT_PEAK_CONCURRENT_INVOCATIONS_NAME,
