...
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.SIZE_HANDLER_CREATE;
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.SIZE_HANDLER_DELETE;
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.SIZE_HANDLER_READ;
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.SIZE_HANDLER_UPDATE;
import static org.jboss.hal.testsuite.test.configuration.logging.LoggingFixtures.SUBSYSTEM_ADDRESS;

@RunWith(Arquillian.class)
public class SizeHandlerSubsystemTest extends SizeHandlerAbstractTest {
    ...
    public static void tearDown() throws IOException, OperationException, InterruptedException, TimeoutException {
        try {
            ops.removeIfExists(handlerAddress(SIZE_HANDLER_CREATE));
            ops.removeIfExists(handlerAddress(SIZE_HANDLER_READ));
            ops.removeIfExists(handlerAddress(SIZE_HANDLER_UPDATE));
            ops.removeIfExists(handlerAddress(SIZE_HANDLER_DELETE));
