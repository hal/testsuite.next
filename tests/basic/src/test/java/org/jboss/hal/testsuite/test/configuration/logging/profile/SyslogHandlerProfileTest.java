...
public class SyslogHandlerProfileTest extends SyslogHandlerAbstractTest {
    ...
    public static void setUp() throws IOException {
        profileName = Ids.build(SyslogHandlerProfileTest.class.getSimpleName(), Random.name());
    ...
    private static Address handlerAddress(String name) {
        return profileAddress.and(SYSLOG_HANDLER, name);
    }
